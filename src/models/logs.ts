...
/**
 * Find a logs by module
 * If logs is find then send response as log details
 */
...
/**
 * Find a logs by module and logLevel
 * If logs is find then send response as log details
 */
